      ...
      <div class="my-3">
        ...
        <form action="{{route('todo.update', $todo->id)}}" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" name="todo-title" id="todo-title" class="form-control" value="{{ $todo->title }}" maxlength="100" required>
          </div>
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="todo-status" name="todo-status">
              @foreach (['WAITING', 'ACTIVE', 'DONE'] as $status)
